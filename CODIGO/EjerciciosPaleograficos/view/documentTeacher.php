...
<div id="labelAux"></div>
        <script>
            ...
            mygrid.setHeader("<?php echo(_("Nombre"));?>, <?php echo(_("Descripción"));?>, <?php echo(_("Tipo escritura"));?>, <?php echo(_("Fecha"));?>, <?php echo(_("Ejercicios"));?>, <?php echo(_("Eliminar"));?>, <?php echo(_("Modificar ficheros"));?>");
            mygrid.setInitWidths("*,*,*,*,100,100,130");
            mygrid.setColAlign("left,left,left,left,center,center,center");
            mygrid.setColTypes("ed,ed,ed,ed,img,img,img");
            mygrid.enableSmartRendering(true);
            mygrid.enableAutoHeight(true,200);
            mygrid.enableAutoWidth(true);
            mygrid.enableTooltips("true,true,true,true,false,false,false");
            mygrid.setSizes();
