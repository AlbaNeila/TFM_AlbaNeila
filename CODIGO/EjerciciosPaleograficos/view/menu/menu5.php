...
?>
        <ul class="menu">
            <li><a class="generalTooltip" href="#"><?php echo(_("Grupos"));?></a></li>
        ...
        <ul class="menu">
            ...
            <li><a href="helpTeacher.php" style="text-decoration: underline"><?php echo(_("Ayuda"));?></a></li>
        </ul>
        <ul class="menu2">
            <li><a href="../controller/logout.php"><?php echo(_("Salir"));?></a></li>
            <li><label><?php echo(_("Bienvenid@:"));?>  <?php echo($_SESSION['usuario_nombre']); ?></label></li>
        ...
        ?>
        <ul class="menu">
            <li><a class="generalTooltip" href="#" style="text-decoration:underline"><?php echo(_("Usuarios"));?></a></li>
