...
?>
        ...
        ?>
        <ul class="menu">
            <li><a class="generalTooltip" href="collectionsTeacher.php" style="text-decoration: underline"><?php echo(_("Colecciones"));?></a></li>
        ...
        ?>
        <ul class="menu">
            <li><a class="generalTooltip" href="usersAdmin.php" style="text-decoration:underline"><?php echo(_("Usuarios"));?></a></li>
